...
export default function Home() {
  ...
  return (
    <main className="h-[100dvh] container">
      ...
      <div className="flex flex-col gap-10 lg:flex-row items-center justify-between lg:my-14 h-[calc(100dvh-420px)]">
        <div className="text-center lg:text-left">
          ...
          <div className="border border-[#FCFDFA] gap-4 mt-6 rounded-[8px] pl-4 flex items-center mx-auto lg:mx-0 sm:w-[470px] overflow-hidden h-[47px] sm:h-[67px] lg:h-[70px]">
            <input
              type="email"
      ...
      <div className="flex items-center justify-center text-[#F6FAF0] gap-6 mt-10">
