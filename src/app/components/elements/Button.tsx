...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <Tag
      ...
      className={clsx(
        'rounded-md justify-center font-[600] whitespace-nowrap focus:outline-none disabled:cursor-not-allowed gap-2 disabled:opacity-70 cursor-pointer flex items-center gap hover:opacity-90 transition-opacity duration-100',
        variant === 'primary' &&
